...
<div class="col-md-8 blog-main">
  ...
  <aside class="col-md-4 blog-sidebar">
    <div class="p-3 mb-3 bg-light rounded">
      ...
      <p class="mb-0">Если до этого момента, вы все еще откладывали решение о начале занятий, то момент настал. Лондонская школа танцев Drive Dance в Москве предлагает удобный формат мастер-классов и полное погружение в танцевальную среду. Мы подготовили несколько вариантов клубных карт, так чтобы каждый смог выбрать для себя подходящее количество и время занятий.</p>
    </div>
